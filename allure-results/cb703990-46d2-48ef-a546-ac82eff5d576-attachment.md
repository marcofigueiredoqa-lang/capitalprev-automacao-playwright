...
- Name: CapitalPrev-Passo01.spec.ts >> Informações do Titular - Data de nascimento futura
- Location: tests\CapitalPrev-Passo01.spec.ts:73:7
...
Locator:  getByText('Campo obrigatório')
Expected: 1
Received: 0
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByText('Campo obrigatório')
    ...
    - generic [ref=e14]:
      ...
      - generic [ref=e20]:
        - generic [ref=e21]:
          ...
          - generic [ref=e26]:
            - generic [ref=e27]: CPF *
            - textbox "Digite seu CPF" [ref=e29]: 089.170.535-05
          - generic [ref=e30]:
            - generic [ref=e31]: Data de nascimento *
            - generic [ref=e32]:
              - generic [ref=e33]:
                - textbox [ref=e35]: 05/10/2097
                - button [ref=e36]:
                  - img [ref=e38]
              - generic [ref=e40]: "Error: A data informada deve ser inferior a data de hoje."
          - generic [ref=e41]:
        ...
        - generic [ref=e79]:
          ...
          - generic [ref=e90]:
            - generic [ref=e91]: CPF *
            - textbox "Digite o CPF" [ref=e93]: 089.170.535-05
          - generic [ref=e94]:
        ...
        - alert [ref=e112]:
          - img [ref=e114]
          - generic [ref=e116]:
            - heading "Erro:" [level=5] [ref=e117]
            - generic [ref=e118]: Confira se a data de nascimento informada está correta
        - button "Continuar" [ref=e119]:
...
> 90 |     await expect(page.getByText('Campo obrigatório')).toHaveCount(1);
     |                                                       ^ Error: expect(locator).toHaveCount(expected) failed
  91 |   });
  92 |   test('Informações do Titular - Data de nascimento antiga', async ({ page }) => {
  93 |     
  94 |   });
  95 | 
  96 | 
